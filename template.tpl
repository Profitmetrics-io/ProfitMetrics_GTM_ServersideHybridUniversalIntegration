...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "PM - Serverside Hybrid Universal Integration",
  "categories": [
    "ADVERTISING",
    "ANALYTICS",
    "ATTRIBUTION",
...
if (data.useHashedEmail && !pmEmailMD5) {
    pmEmailMD5 = pmEmailSHA256;
}

// Check and truncate pmEmailMD5 if it's longer than 32 characters
if (data.useHashedEmail && pmEmailMD5 && pmEmailMD5.length > 32) {
